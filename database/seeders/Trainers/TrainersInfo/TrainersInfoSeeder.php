    ...
    public function run(): void
    {
        ...
        TrainerInfo::firstOrCreate(
            ...
            [
                ...
                'experience_years' => 5,
                'photo'            => Storage::url('Workout/Trainers/Ivanov.png')
            ]
        );
        ...
        TrainerInfo::firstOrCreate(
            ...
            [
                ...
                'experience_years' => 7,
                'photo'            => Storage::url('Workout/Trainers/Sidorov.png')
            ]
        );
        ...
        TrainerInfo::firstOrCreate(
            ...
            [
                ...
                'experience_years' => 12,
                'photo'            => Storage::url('Workout/Trainers/Dmitriev.png')
            ]
        );
        ...
        TrainerInfo::firstOrCreate(
            ...
            [
                ...
                'experience_years' => 8,
                'photo'            => Storage::url('Workout/Trainers/Volkov.png')
            ]
        );
