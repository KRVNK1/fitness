...
export default function Index({ memberships, membershipTypes, filters, users }) {
    ...
    const [typeFilter, setTypeFilter] = useState(filters?.membership_type_id || "")
    ...
    return (
        <>
            <Head title="Управление абонементами" />
                ...
                <main className="flex-1">
                    <div className="p-8">
                        <div className="mb-8 flex items-center justify-between">
                            <div>
                                <h1 className="text-3xl font-bold text-gray-900">Абонементы пользователей</h1>
                                <p className="mt-1 text-gray-600">Управление абонементами пользователей</p>
                            </div>
                            <button
                        ...
                        <div className="mb-6 flex gap-4">
                            <div className="flex-1 flex">
                                <input
                                    type="text"
                                    placeholder="Поиск по имени, фамилии или email пользователя..."
                                    value={searchValue}
                                ...
                                <span
                                    ...
                                    className="w-14 flex justify-center items-center bg-blue-500 rounded-r-lg cursor-pointer"
                                >
