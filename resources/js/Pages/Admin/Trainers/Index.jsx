...
export default function TrainersIndex({ trainers, filters }) {
    ...
    return (
        <>
            <Head title="Управление тренерами" />
                    ...
                    <div className="p-8">
                        <div className="mb-8 flex items-center justify-between">
                            <div>
                                ...
                                <p className="mt-1 text-gray-600">Управление профилями тренеров</p>
                            </div>
                        </div>
